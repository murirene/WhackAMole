...
Tests (Karma for the unit tests and NightWatch for the Functional Test)
	/src/test/actions -- action tests
	/src/test/components -- component rendering tests
	/src/test/functional -- End to End test that verifies all of the functionality 			(Actions->Reducer->Store->Container->Components)
